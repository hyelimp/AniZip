     	...
     	<div class="col-lg-12">
     		<div class="panel panel-default">
     			<div class="panel-heading">
     				<i class="fa fa-comments fa-fw"></i>Reply(댓글) <button id="addReplyBtn" class="btn btn-primary btn-xs pull-right">New Reply(댓글 등록)</button>     			
     			</div>
     			<div class="panel-body">
...
<script type="text/javascript">
	  ...
	  function showList(page) {
		  ...
		  replyService.getList({bno:bnoValue, page: page||1}, function(replyCnt, list) {
		   ...
		   if(page == -1){
		    ...
		    // Page441 아래 1줄 showReplyPage() 메서드 소스 추가 코딩
	...
	$("#addReplyBtn").on("click", function(e) {
			...
			// 아래 hide() 매서드가 포함된 구문을 주석 처리 후 실행 확인해 보시기 바랍니다.
    ...
    modalRegisterBtn.on("click", function(e) {
		...
		replyService.add(reply, function(result) {
			...
			// showList(1); // 댓글 리스트를 갱신 처리하고 1페이지로 리턴처리하는 역할을 합니다.
	...
	modalRemoveBtn.on("click", function(e) {
	  ...
	  /*
	  replyService.add(
		{reply:"Javascript Test~ ＠＠＠!", replyer:"이영자", bno:bnoValue},
		function(result) {
			alert("RESULT 결과값 = " + result);
		}
	  );
	  */
	  ...
	  */
	  ...
	  // 댓글번호(rno)가 17번인 댓글을 삭제 처리해 봅니다!
	  /*
	  replyService.remove(17, function(count) {
			console.log(count);
			if (count === "success") {
				alert("REMOVED 삭제 처리가 정상적으로 이루어졌습니다!");
			}
		}, function(err) {
